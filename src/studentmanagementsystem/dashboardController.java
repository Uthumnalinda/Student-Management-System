...
public class dashboardController implements Initializable {
    ...
    @FXML
    private TableColumn<studentData, String> addStudents_col_secondName;
    ...
    public void addStudentsAdd() {
        ...
        try {
            ...
            if (addStudents_studentNum.getText().isEmpty()
                ...
                // check the student number already exist
    ...
    public void addStudentsInsertImage(){
        ...
        open.getExtensionFilters().add(new ExtensionFilter("Image File", "*jpg", "*png")); //filter insert image formats
    ...
    //add student form
     ...
     public void addStudentsShowListData(){
        ...
        addStudents_col_secondName.setCellValueFactory(new PropertyValueFactory<>("lastName"));
...
//            check the course you want already in
                ...
                if (result.next()) {
                    ...
                    //when i give data to tableview to update the table
     ...
     public void studentGradesUpdate() {
        ...
        try {
            ...
            if (finalCheck1 == 0 || finalCheck2 == 0) {
                finalResult = 0;
            } else { // result is if we take x and y marks as a 2 semesters final = (x+y)/2
    ...
    public void studentGradesSearch() {
        ...
        studentGrade_search.textProperty().addListener((Observable, oldValue, newValue) -> {
            ...
            filter.setPredicate(predicateStudentData -> {
                ...
                if (predicateStudentData.getStudentNum().toString().toLowerCase().contains(searchKey)) {
                    return true;
                } else if (predicateStudentData.getYear().toLowerCase().contains(searchKey)) {
                    return true;
                } else if (predicateStudentData.getCourse().toLowerCase().contains(searchKey)) {
...
//         to updated when click add students button on nav   
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //to show immidiatly when  we going to application form
        addStudentsShowListData();
        addStudentsYearList();
        addStudentsGenderList();
        addStudentsStatusList();
